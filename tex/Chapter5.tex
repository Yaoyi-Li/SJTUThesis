...
在前几章中，本文分别研究了数据驱动的相似性学习在无监督的度量学习和半监督的约束聚类中的应用情况，本章将着重研究相似性学习在具有监督信息的自然图像抠图问题中的算法应用。与前几章中不同之处在于，本章内容将着重关注如何通过数据驱动的网络模型学习相似性的生成方式，而不是直接学习相似性的数值。

传统自然图像抠图算法多采用优化方式对图像像素间的相似性进行利用\cite{levin2008closed,aksoy2017designing}，随着近几年深度卷积神经网络技术的发展\cite{lu2016zhang}，深度卷积神经网络在自然图像抠图方面也表现出显著的优势\cite{xu2017deep,cai2019disentangled}。本章将前文所述的数据驱动的相似性学习思想与基于深度学习的自然图像抠图方法进行结合，研究利用深度神经网络的相似性学习方法及其在自然图像抠图任务中的应用。
\section{引言}
