...
\begin{table}[!htbp]
	...
	% \begin{small}
		...
		\begin{tabular}{l|cccccccccc}
			\toprule
			 &\multicolumn{2}{*}{UMIST} &\multicolumn{2}{*}{COIL20}  &\multicolumn{2}{*}{USPS} &\multicolumn{2}{*}{MNIST} &\multicolumn{2}{*}{ExYaleB}
			\\
			\midrule
			...
			PCAN & \multicolumn{2}{*}{55.30}& \multicolumn{2}{*}{81.74}& \multicolumn{2}{*}{64.20}& \multicolumn{2}{*}{59.83}& \multicolumn{2}{*}{25.89}\\
