...
\begin{figure}[t]
	...
	\bisubcaptionbox{局部HOP模块\label{fig5:blocka}}%
					{local HOP block}
					[0.24\textwidth]{\includegraphics[height=.3\textwidth]{chap5/HOP-local.pdf}}
	\bisubcaptionbox{局部自注意力\label{fig5:blockb}}%
					{local self-attention}
					[0.24\textwidth]{\includegraphics[height=.3\textwidth]{chap5/SA-local.pdf}}	
	\bisubcaptionbox{全局HOP模块\label{fig5:blockc}}%
					{global HOP block}
					[0.24\textwidth]{\includegraphics[height=.3\textwidth]{chap5/HOP-global.pdf}}
	\bisubcaptionbox{全局自注意力\label{fig5:blockd}}%
					{global self-attention}
					[0.24\textwidth]{\includegraphics[height=.3\textwidth]{chap5/SA-global.pdf}}
