...
上一章中提出了基于相似性学习的信息传播在一般性的图像抠图任务上的应用方法，本章将采用与第五章不同的相似性学习方法设计，将数据驱动的相似性学习应用于环境约束更小、实际应用场景更广阔的无trimap图像抠图任务。在本章中我们将提出一种基于弱标注分割蒙版的无trimap图像抠图流程，同时进一步研究如何将引导滤波器的思想方法结合到神经网络中，以达到近似引导上下文注意力机制的效果，在轻量级网络中进行数据驱动的相似性学习，实现移动端的高效实时抠图。
